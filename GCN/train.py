...
def parse_args():
    ...
    parser.add_argument('--mlp_hidden', type=str, default='256,32', help='Comma-separated mlp hidden sizes')
...
def main(args):
    ...
    trainer = pl.Trainer(gpus=1 if torch.cuda.is_available() else None, fast_dev_run=False, max_epochs=num_epochs)
